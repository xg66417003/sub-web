  ...
  <div>
    <el-row style="margin-top: 10px">
      <el-col>
        <el-card>
          <div slot="header">
           本API由'骨朵摸您'提供服务支持👉<a href="https://vpn-4.xyz">前往官网</a><button type="button" class="el-button el-button--default el-button--small" slot="append"><!----><i class="el-icon-link"></i><span>前往官网</span></button>
...
export default {
    ...
    var data = {
      ...
      options: {
        ...
        customBackend: {
          ...
          "sub-beta.now.sh (自动编译最新版本后端）": "https://api.12o.ooo/sub?",
  ...
  mounted() {
    ...
    this.form.customBackend = "https://api.12o.ooo/sub?";
